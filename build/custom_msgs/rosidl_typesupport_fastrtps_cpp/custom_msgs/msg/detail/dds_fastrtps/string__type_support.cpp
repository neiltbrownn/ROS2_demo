...
#include "custom_msgs/msg/detail/string__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::String & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::String & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::String *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::String *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_String__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, String)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_String__handle;
}
